...
class GetHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            elif re.match(fr'\/webcam\/country\/\?{country_regex}', self.path):
                parsed_path = parse.urlparse(self.path)
            ...
            elif re.match(fr'\/minecraft\/country\/\?{country_regex}', self.path):
                parsed_path = parse.urlparse(self.path)
            ...
            elif re.match(fr'\/csgo\/country\/\?{country_regex}', self.path):
                parsed_path = parse.urlparse(self.path)
